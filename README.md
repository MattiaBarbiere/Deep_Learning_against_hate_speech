...
<div style="overflow:auto; margin-bottom:3px; clear:both;">
    <img src="./saved_images/image_attention_overlay_25_16.png" align="right" width=48%">
    <img src="./saved_images/image_attention_overlay_813_16.png" align="left" width=48%">
    <img src="./saved_images/text_attention_overlay_25_16.png" align="right" width=48%">
    <img src="./saved_images/text_attention_overlay_813_16.png" align="left" width=48%">
</div>

See [saved_images](./saved_images/) subfolder for more examples.
